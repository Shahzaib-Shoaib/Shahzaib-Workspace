...
export const footer = {
  widgets: [
    {
      id: 1,
      widgetTitle: "widget_title_social",
      lists: [
        {
          id: 1,
    ...
    {
      id: 2,
      widgetTitle: "widget_title_contact",
      lists: [
        {
          id: 1,
    ...
    {
      id: 3,
      widgetTitle: "widget_title_about",
      lists: [
        {
          id: 1,
          title: "link-about-us",
    ...
    {
      id: 4,
      widgetTitle: "widget_title_customer_care",
      lists: [
        {
          id: 1,
          title: "link-faq",
    ...
    {
      id: 5,
      widgetTitle: "widget_title_our_stores",
      lists: [
        {
          id: 1,
