        ...
        <div className={style.formSection}>
          ...
          <div className={style.field}>
            ...
            type='file'
              ...
              className="mt-2"
            />
          <button className="text-white bg-indigo-500 border-0 py-1 px-4 mt-3 focus:outline-none hover:bg-indigo-600 rounded text-sm"onClick={handleUpload}>Upload</button>
